            ...
            <div className="space-y-5">
                ...
                <Card className="border-slate-700/60">
                    <p className="text-sm text-slate-400">
                        To add yourself, run <span className="font-mono">/link</span> in the Discord server (type your
                        Riot ID to create &amp; link). Unlock admin (top-right) to add players here. Anyone can browse
                        the roster and build teams.
                    </p>
                </Card>
                )}
            </div>
